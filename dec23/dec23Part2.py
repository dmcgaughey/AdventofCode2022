...
for round in range(1000):
	if round%50 == 1:
		print(round, sum([inpos[a]==outpos[a] for a in range(len(inpos))]))
	...
	#Quit looping if none of the robots have moved
	if inpos == outpos:
		break
...
# Calculate box size
print(f'Part 2: Number of round to no movement {round+1}')
